...
\begin{enumerate}
    \item Polynomial regression: We perform model selection based on the BIC score (a measure that takes 
    into account both the complexity and the $R^2$). We pick the model with the 
