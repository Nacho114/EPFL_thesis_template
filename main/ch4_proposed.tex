...
ver basic --- put restrictive --- idea is to assume knowledge about the additive noise, $P_Z$. 
In some sense idea was the precursor to the twin test, where we check if the noise is consistent
