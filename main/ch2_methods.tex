...
We will give a formal description of the HSIC in the next chapter, where we will develop the necessary background 
...
Another type of score function looks at differential en tropies instead of directly testing for independence.
